<script lang="ts">
  let { size = 20, color = "#4C74FF" }: { size?: number; color?: string } =
    $props();
</script>
...
>
  ...
  />
  <!-- Animated bunny eyes -->
  <circle class="bunny-eye-left" cx="8.277" cy="20.466" r="1.8" fill={color} />
  <circle class="bunny-eye-right" cx="19.878" cy="20.466" r="1.8" fill={color} />
  <!-- Happy face on hover -->
  <text
...
<style>
  ...
  .bunny-eye-left {
    opacity: 0;
    animation:
      bunnyEnterEye 0.3s ease-out 0.35s forwards,
      leftEyeLook 5s ease-in-out 0.65s infinite;
  ...
  .bunny-eye-right {
    opacity: 0;
    animation:
      bunnyEnterEye 0.3s ease-out 0.4s forwards,
      rightEyeLook 5s ease-in-out 0.7s infinite;
    transform-origin: center;
    transform-box: fill-box;
  }
  .bunny-ear-left {
    opacity: 0;
    animation:
      bunnyEnterEar 0.3s ease-out 0.1s forwards,
      leftEarTwitch 5s ease-in-out 0.4s infinite;
  ...
  .bunny-ear-right {
    opacity: 0;
    animation:
      bunnyEnterEar 0.3s ease-out 0.15s forwards,
      rightEarTwitch 5s ease-in-out 0.45s infinite;
    transform-origin: bottom center;
    transform-box: fill-box;
  }
  .bunny-face {
